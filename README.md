...
mapping the extended complex plane (the Riemann sphere) to itself. This package
provides a lightweight `MöbiusTransformation` type with constructors, evaluation,
composition, and projective equality.
